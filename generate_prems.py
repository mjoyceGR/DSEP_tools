...
def make_prems_model(mixing_length, Z, Y, aFe, starting_mass, ending_mass, model_dir,interval,model_ID):
	...
	for i in range(low_mass,high_mass,interval):########## 1 corresponds to 0.1 because we're diving by 1000
		...
		if( i>=180):
	    	...
	    	if( i>=300):
			delta=20	
		os.chdir('/home/meridith/dsep3/run/')
